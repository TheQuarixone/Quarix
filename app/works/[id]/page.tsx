...
export default async function WorkPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col">
      ...
      {/* ── Dashed lines ── */}
      <div className="fixed inset-0 pointer-events-none z-[100] flex justify-center px-4 sm:px-6 lg:px-0">
      ...
      <header className="sticky top-0 z-50 border-b border-dashed border-white/25 bg-black/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 sm:px-14 lg:px-20 py-3 sm:py-4 flex items-center justify-between">
          <Link href="/">
